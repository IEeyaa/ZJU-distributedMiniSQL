...
public class API {
    ...
    public static boolean drop_table(String tabName) throws Exception {
        try {
            ...
            if (CatalogManager.drop_table(tabName) && RecordManager.drop_table(tabName))
                return true;
        } catch (NullPointerException e) {
    ...
    public static boolean create_index(Index index) throws Exception {
        if (IndexManager.create_index(index) && CatalogManager.create_index(index))
            return true;
    ...
    public static boolean drop_index(String indexName) throws Exception {
        ...
        if (IndexManager.drop_index(index) && CatalogManager.drop_index(indexName))
            return true;
