...
public class IndexManager {
    ...
    public static Vector<Address> select(Index idx, Condition cond) throws IllegalArgumentException {
        ...
        switch (type) {
            case INT:
                ...
                return IndexManager.<Integer>satisfies_cond(intTree, cond.get_operator(),
                        Integer.parseInt(cond.get_value()));
            case FLOAT:
                floatTree = floatTreeMap.get(idx.indexName);
                return IndexManager.<Float>satisfies_cond(floatTree, cond.get_operator(),
                        Float.parseFloat(cond.get_value()));
            case CHAR:
    ...
    private static <K extends Comparable<? super K>> Vector<Address> satisfies_cond(BPTree<K, Address> tree,
            String operator, K key) throws IllegalArgumentException {
        if (operator.equals("=")) {
