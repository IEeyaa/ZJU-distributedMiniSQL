...
public class RecordManager {
    ...
    // delete the file of given table, return true if success, otherwise return
    // false
    ...
    public static Address insert(String tableName, TableRow data) throws Exception {
        ...
        Block insertBlock = BufferManager.read_block_from_disk_quote(tableName, blockOffset); // read the block for
                                                                                              // inserting
    ...
    // delete the condition-satisfied tuples from given table, return number of
    // deleted tuples
    ...
    // select the tuple from given list of address on one table with conditions,
    ...
    // delete the tuples from given address on one table with conditions, return the
    // number of delete tuples
    ...
    // do projection on given result and projected attribute name in given table,
    ...
    // get the tuple from given table according to stored block and start byte
    // offset
            ...
            case "CHAR":
                if (length < value.length())
                    throw new IllegalArgumentException(
                            "The char number " + value + " must be limited in " + length + " bytes");
                break;
            default:
